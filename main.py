...
stmt: optional_expression ";" -> optional_expression_statement
...
def main(argv):
    ...
    for opt, arg in opts:
        ...
        print(arg)
        print("HERE")
    with open(os.path.join("D:\\University\\7\\Compiler\\Project\\compiler_fall_2021\\tests", inputfile), "r") as input_file:
        try:
